...
조합형(composed) mixed → **인물 일관 드리프트형(coherent persona drift)**: 한 인물의
다중 세션 히스토리에서 사건이 세션 간 변화로만 드러나게 생성. 어느 세션도 단독으론
사건을 증명 못 하게 하여 (a) 단일 세션 탐지 무력화, (b) 진짜 다중 세션 통합 강제,
(c) 포화 해제, (d) 진짜 누적 곡선 형성.
